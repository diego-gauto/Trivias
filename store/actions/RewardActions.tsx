...
export const addLevel = async (level: any) => {
  const docRef = await addDoc(collection(db, 'levelPoints'), {
    ...level,
  });
  return 'exito';
};
export const addLevelTime = async (level: any) => {
  const docRef = await addDoc(collection(db, 'levelTimes'), {
    ...level,
  });
  return 'exito';
};
...
export const addReward = async (reward: any) => {
  ...
  const docRef = await addDoc(collection(db, 'allRewards'), {
    ...reward,
  });
...
export const updateRewards = async (reward: any, id: any) => {
  ...
  if ('format' in tempReward) {
    ...
    tempReward.path = await uploadPointRewardsImage(
      tempReward.format,
      tempReward.reference,
    );
...
export const addTimeReward = async (reward: any) => {
  ...
  const docRef = await addDoc(collection(db, 'rewardsTime'), {
    ...reward,
  });
  return 'exito';
};
...
export const updateTimeRewards = async (reward: any, id: any) => {
  ...
  if ('format' in tempReward) {
    ...
    tempReward.path = await uploadTimeRewardsImage(
      tempReward.format,
      tempReward.reference,
    );
    delete tempReward.format;
