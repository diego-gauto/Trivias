...
import {
  ModalContainer,
  InfoContainer,
} from '../../../components/Error/ErrorModal.styled';
import {
  InputCard,
  WhiteLoader,
} from '../../../containers/Profile/User/User.styled';
  ...
  return (
    <ModalContainer show={show} onHide={ondHide} centered>
      <InfoContainer>
        ...
        <p>
          Aún faltas tú. Tus datos no fueron actualizados. Reinténtalo
          nuevamente.
        </p>
        <p>
          Gonvar está pasando por un cambio importante en beneficio de nuestras
          alumnas.
        </p>
        <p className='p14'>
          🚨Para esto es necesario que vuelvas a ingresar tus datos bancarios
          para no perder el acceso a tu suscripción mensual por $149 MXN al mes
          y todos tus beneficios acumulados. La plataforma te cobrará de forma
          inmediata y quedarás suscrita.
        </p>
        <p className='p14-bold'>
          A partir del 18 de septiembre aumentaremos nuestros precios en la
          suscripción mensual a $249 MXN al mes.{' '}
        </p>
        <p className='p14'>
          Todas las alumnas que cuenten con su suscripción activa antes de esta
          fecha se les respetará el precio actual y{' '}
          <span className='p14-bold' style={{ fontWeight: 'bold' }}>
            no habrá aumento en su mensualidad.
          </span>
        </p>
        <p className='p14'>
          Para realizar la compra de tu suscripción mensual ingresa nuevamente
          tu método de pago. Recuerda que necesitarás contar con una tarjeta de
          crédito o débito vigente.{' '}
        </p>
        <p className='p14'>
