          ...
          <div className='right-side' style={{ overflow: 'hidden' }}>
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className='box'>
                ...
                <div
                  className='form-row'
                  style={error ? { flexDirection: 'column', gap: 2 } : {}}
                >
                  <div className='form-input'>
                ...
                <div
                  className='form-row'
                  style={errors.password && { flexDirection: 'column', gap: 5 }}
                >
                  <div className='form-input'>
                ...
                <div className='form-row'>
                  ...
                  {errorPhone && <div className='error'>{errorPhoneMsg}</div>}
                </div>
              ...
              {!authLoader ? (
                <PurpleButton2 type='submit'>Crear Cuenta</PurpleButton2>
              ) : (
                <LoaderImage>
                  <LoaderContain />
                </LoaderImage>
