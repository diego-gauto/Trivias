...
const forms: Form[] = [
  ...
  },
  {
    ...
    subtitle: "<p><strong>Válido Sólo desde Hoy y máximo este domingo 17 de diciembre</strong> los mejores precios en <strong>producto de uñas</strong> nunca antes vistos. 🔥<br>🎄¡Navidad está cerca! Y Gonvar te quiere consentir.<br><br>Recuerda que al ser un Kit LIMITADO y con descuento tienes máximo hasta el Domingo para poder realizar tu pago. Este es un regalo que les damos a todas ustedes con todo el cariño para que puedan darle el mejor uso a todos los productos y lo disfruten al máximo con ustedes y sus clientas. Te contactaremos lo más rápido posible para confirmar tu kit y darte indicaciones de pago y envíos.</p>",
    createdAt: "15-12-2023 16:28:23",
    editedAt: "15-12-2023 16:36:42",
    img: { source: "/images/forms/mistery box gonvar.png", isVisible: true },
    optionsArray: [
      { isVisible: true, label: "<p><strong>Elige sólo uno</strong> para apartarlo y </span><strong>consiéntete esta navidad.</strong> 🙋🏻‍♀️<br><strong>Hazlo</strong> sólo sí estás comprometida a completar tu pago <strong>máximo el domingo</strong>, ya que estos son LIMITADOS y al seleccionarlo dejarás a alguien fuera<br>Te mandaremos un mensaje de Whatsapp para confirmarte tu pedido.<br><br>Recomendación: La Mystery Box contiene <strong>GRANDES SORPRESAS Y</strong><br><strong>70 PRODUCTOS SECRETOS de la Marca</strong> donde ahorras $1,899 pesos y obtienes hasta 70% de descuento.", options: ["Pincel (Precio real: $1,620MXN) NO pagarás eso. Precio para ti: 1,199MXN", "Kit de manicura y Drill  (Precio real: $. 2,078 MXN) NO pagarás eso. Precio para ti: 1,799 MXN", "Apartar Kit Nails Máster(Precio real: $.3,654MXN) NO pagarás eso. Precio para ti: $1,949MXN", "Mystery  Box (Precio real: $3,699MXN) NO pagarás eso. Precio para ti: $1,999MXN"] },
