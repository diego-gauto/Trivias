...
const arita_responsive =
  '/images/landing_suscription/responsive/arita_responsive.svg';
const chica_responsive =
  '/images/landing_suscription/responsive/chica_fondo.svg';
    ...
    <SuscriptionContain>
      <div className='section mt-0'>
        ...
        <div className='space'>
          <h2 className='big-text '>
            <b>Nail's Master </b>
            <b className='light-p'>2.0</b>
          </h2>
          <h2 className='subtitle'>
            <b>Aprende a aplicar uñas </b>
            <b className='p-pink'>desde cero.</b>
          </h2>
        </div>
        ...
        <h4 className='extra-margin'>
          ...
          <b className='p-pink'>
            ...
            <br />
            {responsive850 && <br />}
            Más de 5,700 alumnas{responsive850 && <br />}
          </b>{' '}
      ...
      <div className='info'>
              ...
              <div className='uñas-q'>
                ...
                >
                  ...
                  <div className='border-top'>
                    <p>
                      ...
                      <b className='p-pink'>útiles y cómodas.</b>
                    </p>
                    <p>
                      <b>
                ...
                >
                  ...
                  <div className='border-top'>
                    ...
                    <p>
                      <b>✅ Aprende los</b>
                      <b className='p-pink'> lineamientos de acomodo </b>
                      <b>
                        de materiales para evitar riesgos de derrame y
                        quemaduras.
                        <i>(Prevención de accidentes)</i>
                      </b>
                    </p>
                    <p>
                      ✅<b className='p-pink'> Aprende el uso correcto</b>
                      <b>
                        {' '}
              ...
              <div className='uñas-q'>
                ...
                >
                  ...
                  <div className='border-top'>
                    <p>
                      ✅<b> Logra aplicaciones </b>
                      <b className='p-pink'>hermosas y detalladas.</b>
                    </p>
                    <p>
                      ✅
                      <b>
                      ...
                      <b className='p-pink'>lineamientos europeos.</b>
                    </p>
                    <p>
                      ✅
                      <b className='p-pink'>
                      ...
                      <b className='p-pink'> de alto impacto.</b>
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className='border-top'>
                    <p>
                      ✅<b> Logra aplicaciones </b>
                      <b className='p-pink'>con duración de más de 21 días.</b>
                    </p>
                    <p>
                      ✅<b> Domina el </b>
                      <b className='p-pink'>cero desprendimiento.</b>
                    </p>
                    <p>
                      ✅<b className='p-pink'> Garantiza </b>
        ...
        <h2 className='h1 bold'>
          ...
          <b className='p-pink no-bold'>vive de tu pasión</b> <br /> por las
          uñas acrílicas
        </h2>
        <div className='info-cards all-center'>
          <div className='card'>
            ...
            <p>
              Revisamos de manera individual cada una de tus prácticas y te
      ...
      <div className='video-section'>
        ...
        <div className='info-video'>
          <h2>
            <b className='title-text'>Durante 3 meses podrás acceder a</b>
            <br />
            <b className='big-title p-pink'>más de 40 clases</b>
          </h2>
          ...
          <div className='text-container'>
            ...
            <p className='p-pink'>
              <b>
                ...
                {responsive850 && <br />} Nails Master 2.0
              </b>
            </p>
            <div className='sangria'>
              <p>
                ...
                artificiales por {responsive850 && <br />}competencia.
              </p>
              <p>
                <b>
      ...
      <div className='benefits-section'>
        <h2 className='text-blue'>
          Con <b className='blue'>Nails Master 2.0</b> te
        ...
        <div className='benefits-info'>
          ...
          <div className='info-row'>
            <div className='info-content'>
              ...
              <h5>
                3 meses de acceso a <b>Nails Master 2.0</b>
              </h5>
            </div>
          ...
          <div className='info-row gray'>
            <div className='info-content'>
              ...
              <h5>
                Más de 40 lecciones completas,<b> actualizadas al 2023</b>
              </h5>
            </div>
            <div className='info-content info-side'>
          ...
          <div className='info-row'>
            <div className='info-content'>
              ...
              <h5>
                Revisión de prácticas y <b>asesorías ilimitadas</b>
              </h5>
            </div>
            <div className='info-content info-side'>
          ...
          <div className='info-row gray'>
            <div className='info-content'>
              ...
              <h5>
                <b>Curso definitivo</b> con las técnicas más solicitadas
              </h5>
            </div>
            <div className='info-content info-side'>
              <img src={bulb} className='icon' />
              <h5>
                Programa enfocado al <b>Emprendimiento</b>
              </h5>
            </div>
          </div>
          <div className='info-row'>
            <div className='info-content'>
              ...
              <h5>
                <b>Certificado oficial</b> al terminar el curso, con folio único
                verificado (FUV)
              </h5>
            </div>
            <div className='info-content info-side'>
              ...
              <h5>
                <b>Horarios flexible,</b> nuestro curso es 100% online
              </h5>
            </div>
          </div>
      ...
      <div className='program'>
        <h2 className='yellow h1'>
          <b>
            Todo lo que incluye este {responsive850 && <br />}increíble programa
          </b>
        </h2>
        {!responsive850 ? (
          <p className='h4'>
            <b>
              Para complementar tu aprendizaje, al inscribirte a Nails Master
              2.0 <br />
              obtendrás cuadernillos, manuales y textos que te ayudarán en tu
              carrera de Nail Artist.
            </b>
          </p>
        ) : (
          <p className='h4'>
            Para complementar tu aprendizaje, <br />
            al inscribirte a Nails Master 2.0
            <br />
            <b>
              {' '}
        ...
        <div className='program-course'>
          <div className='course-container'>
            <div className='course-detail'>
              <img src={book} className='icon' />
              <p>
                Curso {responsive850 && 'Nails Master 2.0'}
                {responsive850 ? <br /> : ' | '}
                <b className='p-pink'>Costo real: $2,399.00 MXN</b>
              </p>
            </div>
            <div className='course-detail'>
              <img src={book} className='icon' />
              <p>
                ...
                {responsive850 ? <br /> : ' |'}
                <b className='p-pink'>Costo real: $490.00 MXN</b>
              </p>
            </div>
            <div className='course-detail'>
              <img src={book} className='icon' />
              <p>
                ...
                {responsive850 ? <br /> : ' |'}
                <b className='p-pink'>Costo real: $239.00 MXN</b>
              </p>
            </div>
            <div className='course-detail'>
              <img src={book} className='icon' />
              <p>
                ...
                <b className='p-pink'>Costo real: $297.00 MXN</b>
              </p>
            </div>
            <div className='course-detail'>
              <img src={book} className='icon' />
              <p>
                ...
                {responsive850 ? <br /> : ' |'}
                <b className='p-pink'>Costo real: $497.00 MXN</b>
              </p>
            </div>
            <div className='course-detail'>
              <img src={book} className='icon' />
            ...
            <div className='course-detail'>
              ...
              <div className='d-block text-start'>
                <p>
                  ...
                  <br />
                  <b className='p-pink'>Costo real: $850.00 MXN</b>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className='rewards-container all-center'>
          <div className='reward-card card-style'>
            <div className='normal-card'>
              ...
              <h4 className='light-p'>
                Recompensas {responsive500 && <br />}por puntaje
              </h4>
              <h5>
                Cada tarea aprobada, clase o curso terminado, te dará{' '}
                <b className='p-pink'>puntos </b>
                que puedes canjear por productos Gonvar.
              </h5>
            </div>
            <div className='hover-card'>
              ...
              <p>
                Tarea aprobada: +50 pts
                <br />
                Clase terminada: +100 pts
                <br />
                Curso terminado: +150 pts
              </p>
            </div>
          </div>
          {!responsive850 ? (
      ...
      <div className='experiences-section'>
        {!responsive850 ? (
          <h2 className='h1 bold'>
            Conoce las experiencias de nuestras alumnas
          </h2>
        ) : (
          <h2 className='h1 bold'>
            Más de 45,000
          ...
          <div className='side'>
            <div className='subject'>
              <div className='lessons'>
                ...
                <h3 className='title'>
                  <b>¿Cómo funciona la plataforma?</b>
                </h3>
              </div>
              <h5>
                <b className='p-pink'>Lección 1.</b> ¿Cómo funciona la
                plataforma?.
              </h5>
              <h5>
                <b className='p-pink'>Lección 2.</b> Entrega de Prácticas y
                Certificados
              </h5>
            </div>
            <div className='subject'>
              <div className='lessons'>
                ...
                <h3 className='title'>
                  <b>Bienvenida a Nails Master 2.0</b>
                </h3>
              </div>
              <h5>
                <b className='p-pink'>Lección 1.</b> Presentación y Bienvenida.
              </h5>
              <h5>
                <b className='p-pink'>Lección 2.</b> Objetivos y Perfil de
                Egreso.
              </h5>
              <h5>
                <b className='p-pink'>Lección 3.</b> ¿Cómo evaluaremos tu
                aprendizaje?
              </h5>
            </div>
            <div className='subject'>
              <div className='lessons'>
                ...
                <h3 className='title'>
                  <b>Productos y Herramientas Para Comenzar</b>
                </h3>
              </div>
              <h5>
                <b className='p-pink'>Lección 1.</b> Herramientas Necesarias
                Para la Aplicación de Uñas Acrílicas.
              </h5>
              <h5>
                <b className='p-pink'>Lección 2.</b> Productos necesarios para
                la aplicación de uñas acrílicas.
              </h5>
              <h5>
                <b className='p-pink'>Lección 3.</b> Pincel Gonvar Nails 100%
                Kolinsky.
              </h5>
              <h5>
                <b className='p-pink'>Lección 4.</b> Herramientas Eléctricas y
                Mobiliario.
              </h5>
              <h5>
                <b className='p-pink'>Lección 5.</b> Dónde Comprar Tus
                Productos.
              </h5>
            </div>
            <div className='subject'>
              <div className='lessons'>
                ...
                <h3 className='title'>
                  <b>
                    Fundamentos Teóricos para la Aplicación de Uñas Acrílicas
                  </b>
                </h3>
              </div>
              <h5>
                <b className='p-pink'>Lección 1.</b> Morfología de la Uña
                Natural.
              </h5>
              <h5>
                <b className='p-pink'>Lección 2.</b> Partes de la Uña
                Artificial.
              </h5>
              <h5>
                <b className='p-pink'>Lección 3.</b> Diferencia entre
                Enfermedades, Alteraciones e Infecciones en las Uñas Naturales.
              </h5>
              <h5>
                <b className='p-pink'>Lección 4.</b> Alteraciones de las Uñas
                Naturales.
              </h5>
              <h5>
                <b className='p-pink'>Lección 5.</b> Cero Desprendimiento:
                Teoría Técnica 25*4 y Preparación de la Uña Natural.
              </h5>
            </div>
          </div>
          <div className='side'>
            <div className='subject'>
              <div className='lessons'>
                ...
                <h3 className='title'>
                  <b>Comportamiento de los Productos Químicos</b>
                </h3>
              </div>
              <h5>
                <b className='p-pink'>Lección 1.</b> La perla Perfecta 1.
              </h5>
              <h5>
                <b className='p-pink'>Lección 2.</b> La perla Perfecta 2.
              </h5>
              <h5>
                <b className='p-pink'>Lección 3.</b> La perla Perfecta 3.
              </h5>
              <h5>
                <b className='p-pink'>Lección 4.</b> La perla Perfecta 4.
              </h5>
              <h5>
                <b className='p-pink'>Lección 5.</b> La perla Perfecta 5.
              </h5>
              <h5>
                <b className='p-pink'>Lección 6.</b> La perla Perfecta 6.
              </h5>
            </div>
            <div className='subject'>
              <div className='lessons'>
                ...
                <h3 className='title'>
                  <b>
                    Práctica en Mano Real de Técnicas y Diseños Más Comerciales
                  </b>
                </h3>
              </div>
              <h5>
                <b className='p-pink'>Lección 1.</b> ¿Cómo medir el Tip?
              </h5>
              <h5>
                <b className='p-pink'>Lección 2.</b> Punta Coffin: Aplicación
                con Técnica Perfect Natural.
              </h5>
              <h5>
                <b className='p-pink'>Lección 3.</b> Punta Coffin: Limado.
              </h5>
              <h5>
                <b className='p-pink'>Lección 4.</b> Punta Cuadrada con
                Curvatura C: Aplicación con técnica Full Cover.
              </h5>
              <h5>
                <b className='p-pink'>Lección 5.</b> Punta Cuadrada con
                Curvatura C: Limado.
              </h5>
              <h5>
                <b className='p-pink'>Lección 6.</b> Punta Cuadrada con
                Curvatura C: Finalizado con Esmalte en Gel.
              </h5>
              <h5>
                <b className='p-pink'>Lección 7.</b> Punta Almendra Clásica:
                Aplicación con Técnica de Encapsulado.
              </h5>
              <h5>
                <b className='p-pink'>Lección 8.</b> Punta Almendra Clásica:
                Limado.
              </h5>
              <h5>
                <b className='p-pink'>Lección 9.</b> Almendra Clásica:
                Finalizado.
              </h5>
              <h5>
                <b className='p-pink'>Lección 10.</b> Aplicación de Francés para
                Uñas con Onicofagia.
              </h5>
              <h5>
                <b className='p-pink'>Lección 11.</b> Francés: Limado.
              </h5>
              <h5>
                <b className='p-pink'>Lección 12.</b> Francés: Finalizado.
              </h5>
              <h5>
                <b className='p-pink'>Lección 13.</b> Extra: Drill.
              </h5>
              <h5>
                <b className='p-pink'>Lección 14.</b> Certificación.
              </h5>
            </div>
          </div>
        </div>

        <button className='btn up-down' onClick={() => setverMat(true)}>
      ...
      <div className='devices-section py-5'>
        <h2 className='big-title bold'>
          ...
          <b className='p-pink no-bold'>desde cualquier dispositivo</b>
        </h2>
            ...
            >
              ...
              <div className='border-top'>
                <p className='a'>
                  ...
                  de crédito o débito.
                  <i>
                    (El cobro se realiza de manera automática mes con mes por la
                    cantidad de $149 MXN u 8 dls.)
                  </i>
                  <br />
