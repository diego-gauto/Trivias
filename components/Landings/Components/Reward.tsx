  ...
  if (nails_master) {
        ...
        <div className='card-container'>
          <div className='reward-card points'>
            <div className='normal-card'>
              ...
              <p className='bold m-5'>
                Cada tarea aprobada, clase o curso terminado, te dará puntos que
                puedes canjear por productos Gonvar.
              </p>
            </div>
            <div className='hover-card'>
              ...
              <p>
                ...
                <b className='yellow'>2 monómetros Gonvar</b>
              </p>
              <h3 className='yellow bold'>
                al reunir <br /> 3,000 puntos
              </h3>
            </div>
          </div>
          <div className='reward-card time'>
            <div className='normal-card'>
              ...
              <p className='bold m-5'>
                Por cada mes que permanezcas suscrita, obtendrás nuevos
                beneficios y mejores descuentos en nuestros productos.
              </p>
            </div>
            <div className='hover-card'>
              ...
              <h2 className='h1'>¡HOLA MARÍA!</h2>
              <p>
                Tu siguiente recompensa <br /> estará disponible{' '}
                <b className='yellow'>en Junio</b>
              </p>
              <h3 className='yellow bold' style={{ fontSize: '1.5rem' }}>
                20% de descuento <br /> en productos Gonvar
              </h3>
            </div>
          </div>
          <div className='reward-card awards'>
            <div className='normal-card'>
              ...
              <p className='bold m-5'>
                Recibe un certificado oficial de la marca con un Folio Único
                Verificado (FUV) por cada curso completo que termines.
              </p>
            </div>
            <div className='hover-card'>
              ...
              <h2 className='h1'>¡HOLA MARÍA!</h2>
              <p>
                Tu siguiente curso a terminar es <br />{' '}
                <b className='yellow'>MANICURE CON BALANCE</b>
              </p>
              <h3 className='yellow bold'>
                Has conseguido 15 <br /> Certificados FUV
              </h3>
            </div>
          </div>
        </div>
    ...
    return (
      <RewardsContainer>
        ...
        >
          Gracias a nuestro sistema de puntos,{responsive650 && <br />}{' '}
          beneficios y certificados acumulables, <br />
          ...
          sólo por{' '}
          <b>
            permanecer suscrita, concluir tus {responsive650 && <br />}cursos y
            hacer tus tareas.
          </b>
        </h5>
      </RewardsContainer>
