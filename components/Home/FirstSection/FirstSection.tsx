...
export const FirstSection = (props: IFirstSectionProps) => {
  ...
  const responsiveXl = useMediaQuery({
    query: '(min-width: 991px) and (max-width: 1200px)',
  });
  ...
  return (
    <FirstSectionContainer>
      ...
      <Row>
        {responsive991 && (
          <Col sm={12} lg={6} className='right-side'>
            <div className={!img ? 'skeleton-product' : ''}></div>
        ...
        <Col
          sm={12}
          lg={6}
          className={'left-side' && !img ? ' skeleton-product' : ''}
        >
          <div className='grey-field'>
          ...
          {!responsiveXl && !responsiveHeight700 && (
            <Row className='features mt-5'>
              ...
              <Col xs={6} sm={6} md={6} lg={6} xl={4} className='text-center'>
                <div className='grey-field'>
                  <Feature
                    title={data?.segundaCaracteristica}
                    image={Img4.src}
                  />
                </div>
              </Col>
              ...
              >
                <div className='grey-field'>
                  <Feature
                    title={data?.terceraCaracteristica}
                    image={Img3.src}
                  />
                </div>
              </Col>
