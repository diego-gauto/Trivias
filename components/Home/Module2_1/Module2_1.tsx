          ...
          <>
            {responsive1023 && (
              <img
                ...
                src='../images/Landing/mobileBG2.png'
                alt=''
              />
            )}
            <img
              className='background'
              src='../images/Landing/bgSection1.png'
              alt=''
            />
            <img
              className='women'
              src='../images/Landing/mujeres_gonvar-min.png'
              alt=''
            />
            <div className='left-side'>
              <h1 style={{ display: 'none' }}>Academia de belleza</h1>
              {!responsive1023 && (
                <Tittle className='col-4'>
                  {landingData['tituloInicial']}
                </Tittle>
              )}
              {responsive1023 && (
                <Tittle>{landingData['tituloInicial']}</Tittle>
              )}
              {!responsive1023 && (
                <Subtittle1 className='col-3'>
                  <p
                    dangerouslySetInnerHTML={{
                      __html: landingData['parrafoInicial'],
                    }}
                  />
                </Subtittle1>
              )}
              {responsive1023 && (
                <Subtittle1 className='m-3'>
                  <p
                    dangerouslySetInnerHTML={{
                      __html: landingData['parrafoInicial'],
                    }}
              ...
              <div className='buttons'>
                <PurpleModule2Button
                  b1text={landingData['botonPrimario']}
                  n1text={''}
                  onClick={startFromRedirect}
                />
                <PurpleEmptyButton
                  text={landingData['botonSecundario']}
                  onClick={() => {
                    goToPreview();
                  }}
                />
            ...
            {responsive1023 && (
              <img
                className='women-second'
                src='../images/Landing/infoWomen.png'
                alt=''
              />
            )}
          </>
