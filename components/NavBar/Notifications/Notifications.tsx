    ...
    if (
      ...
      router.push({
        ...
        query: {
          ...
          season: notification.season ?? 0,
          lesson: notification.lesson ?? 0,
        },
      });
  ...
  useEffect(() => {
    if (notification.type === '3' || notification.type === '4') {
      ...
      if (user_like_id !== undefined && user_comment_id !== undefined) {
        userById(type === '4' ? user_like_id + '' : user_comment_id + '').then(
          (res) => {
      ...
      <div className='notification-data' onClick={ClickNotification}>
        {notification.type !== '3' && notification.type !== '4' && (
          <img
            ...
            src={returnNotificationImage(notification)}
          />
        )}
        {(notification.type === '3' || notification.type === '4') && (
          <div style={{ position: 'relative' }}>
            ...
            <div className='circle'>
              <img
                src={
                  notification.type === '3'
                    ? '/images/notifications/comment.png'
                    : '/images/notifications/like.png'
                }
                alt=''
              />
            </div>
        ...
        <div className='notification-texts'>
          <div className='notification-info'>
            <p className='title'>
              {returnNotificationTitles(notification, user.name)}
            </p>
            <p className='message'>
              {returnNotificationMessage(
                notification,
            ...
            {(notification.type === '1' || notification.type === '2') && (
              <p className='score'>
                {notification.type === '1' ? `Aprobada` : `Rechazada`}
                {notification.type === '1' ? (
