...
const ThankYouAlineacion = () => {
  ...
  const goTo = () => {
    window.location.href = '/lesson?id=45&season=0&lesson=0';
  };
  ...
  return (
    <ThankYouContainer>
      <div className='left'>
        ...
        <p>
          Ahora puedes acceder a nuestros cursos de manera <br />
...
export default ThankYouAlineacion;
