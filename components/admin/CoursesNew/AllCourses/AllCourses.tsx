...
const AllCourses = (props: AllCoursesProps) => {
  ...
  const addProfessors = (val: any) => {
    ...
    if (tempProfessor.some((e: any) => e.professors_id === val.professors_id)) {
      tempIndex = tempProfessor.findIndex(
        (x: any) => x.professors_id == val.professors_id,
      );
  ...
  const addCategories = (val: any) => {
    ...
    if (tempCategory.some((e: any) => e.categories_id === val.categories_id)) {
      tempIndex = tempCategory.findIndex(
        (x: any) => x.categories_id == val.categories_id,
      );
  ...
  const addMaterials = (val: any) => {
    ...
    if (tempMaterials.some((e: any) => e.materials_id === val.materials_id)) {
      tempIndex = tempMaterials.findIndex(
        (x: any) => x.materials_id == val.materials_id,
      );
  ...
  const sendNotificationToUser = async (userId: number) => {
    try {
      const createNotificationResponse = await postGenericQueryResponse(
        "insert into notification (type) values ('10');",
      );
      const insertIdNotification =
        createNotificationResponse.data.data.insertId;
  ...
  return (
    <div className='edit-course' id={`course-${index}`}>
      <div
        ...
        onClick={() => {
          openCourse(index), moveTo(index);
        }}
      >
        <p className='title'>
          {type === 'Mensual' && <img src={GonvarImg} style={{ width: 30 }} />}{' '}
          {title}{' '}
        </p>
        ...
        <div className='course-content'>
          ...
          <div className='rows'>
            <div className='course-data'>
              <label className='course-data-title'>Título</label>
              {!startEdit ? (
            ...
            <div className='course-data'>
              <label className='course-data-title'>Subtítulo</label>
              {!startEdit ? (
                ...
                <input
                  ...
                  style={
                    errors.errorSubtitle ? { border: '1px solid red' } : {}
                  }
                  onChange={(e: any) => {
                    setCourse({
                      ...course,
            ...
            <div className='course-data'>
              <label className='course-data-title'>Descripción</label>
              {!startEdit ? (
          ...
          <div className='rows'>
            <div className='course-data'>
              <label className='course-data-title'>Dificultad</label>
              {!startEdit ? (
                <p className='content'>{difficulty}</p>
              ) : (
                <SelectOption
            ...
            <div className='course-data'>
              <label className='course-data-title'>Secuencial</label>
              {!startEdit ? (
                <p className='content'>
            ...
            <div className='course-data'>
              <label className='course-data-title'>Color</label>
              {!startEdit ? (
                <p className='content'>{certificate_color}</p>
              ) : (
                <SelectOption
          ...
          <div className='rows'>
            <div className='course-data'>
              <label className='course-data-title'>Calificación</label>
              {!startEdit ? (
            ...
            <div className='course-data'>
              <label className='course-data-title'>Reviews</label>
              {!startEdit ? (
            ...
            <div className='course-data'>
              <label className='course-data-title'>Tipo</label>
              {!startEdit ? (
                <p className='content'>{type}</p>
              ) : (
                <SelectOption
                  onClick={() =>
                    setOpenProductTypeSelect(!openProductTypeSelect)
                  }
                >
                  {course.type}
          ...
          <div className='rows'>
            <div className='course-data'>
              <label className='course-data-title'>Precio</label>
              {!startEdit ? (
            ...
            <div className='course-data'>
              <label className='course-data-title'>Duracion (dias)</label>
              {!startEdit ? (
                <p className='content'>
            ...
            <div className='course-data'>
              <label className='course-data-title'>Frase descriptiva</label>
              {!startEdit ? (
                <p className='content'>{phrase}</p>
              ) : (
                <input
                  className='input-edit'
                  defaultValue={phrase}
          ...
          <div className='rows'>
            <div className='course-data'>
              <label className='course-data-title'>Instructor (es)</label>
              {!startEdit ? (
                <p className='content'>
                  {professors.length > 0
                ...
                <SelectOption
                  ...
                  style={
                    errors.errorProfessor ? { border: '1px solid red' } : {}
                  }
                >
            ...
            <div className='course-data'>
              <label className='course-data-title'>Categoría</label>
              {!startEdit ? (
                <p className='content'>
                  {categories.length > 0
                ...
                <SelectOption
                  ...
                  style={
                    errors.errorCategory ? { border: '1px solid red' } : {}
                  }
                >
            ...
            <div className='course-data'>
              <label className='course-data-title'>Materiales</label>
              {!startEdit ? (
                <p className='content'>
                  {materials.length > 0
          ...
          <div className='rows'>
            <div className='course-data'>
              <label className='course-data-title'>Publicado</label>
              {!startEdit ? (
                <p className='content'>
            ...
            <div className='course-data'>
              <label className='course-data-title'>Ruta de Aprendizaje</label>
              {!startEdit ? (
                <p className='content'>{route ? route : 'Sin ruta'}</p>
              ) : (
                <select
                  onChange={(e) => {
            ...
            <div className='course-data'>
              <label className='course-data-title'>Numero del curso</label>
              {!startEdit ? (
                <p className='content'>{course_number}</p>
              ) : (
                <input
                  className='input-edit'
                  type='number'
          ...
          <div className='rows'>
            {startEdit && (
              <>
                ...
                <div className='course-data'>
                  ...
                  <select
                    defaultValue={with_certificate ? 1 : 0}
                    onChange={(e) => {
                      setCourse({
                        ...course,
                        with_certificate: parseInt(e.target.value),
                      });
                    }}
                  >
            ...
            <div className='course-data'>
              <label className='course-data-title'>Ruta de Materiales</label>
              {!startEdit ? (
                <p className='content'>
          ...
          >
            ...
            {!startEdit && canEdit && (
              <div className='button-data'>
                <button className='save-button' onClick={() => goToSeasons()}>
                  Ver Temporadas
                </button>
              </div>
            )}
