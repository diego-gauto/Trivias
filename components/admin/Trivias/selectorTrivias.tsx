...
const SelectorTrivias = () => {
  ...
  return (
    <Container>
      {
        ((userLevel === 'admin' && (canViewTrivias && (canCreateTrivias || canEditTrivias)))
          || userLevel === 'superAdmin') && <ButtonContainer>
      ...
      {
        ((userLevel === 'admin' && (canViewTriviasList || canDownloadTriviasList))
          || userLevel === 'superAdmin') && <ButtonContainer>
