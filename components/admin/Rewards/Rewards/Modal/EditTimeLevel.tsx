...
import { addLevelTime, deleteLevel, deleteTimeLevel, updateLevel, updateLevelTime } from "../../../../../store/actions/RewardActions";
...
const EditTimeLevel = ({ show, setShow, levels }: any) => {
              ...
              levels.map((level: any, index: any) => {
                return (
                  <LevelContain key={"editLevel" + index}>
                    ...
                    <ButtonContain>
                      <Button onClick={() => {
                        updateLevelTime(level, level.id)
                      }}>Guardar</Button>
                    </ButtonContain>
                  </LevelContain>
                )
