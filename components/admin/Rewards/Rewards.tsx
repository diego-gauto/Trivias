...
import { getRequestsApi, getRewardsApi, IRequest, IReward, IRewardResponse, printRequestsType, updateRequestStatusApi } from "../../api/rewards";
    ...
    <AdminContain>
      <RewardContain>
        ...
        <div className="top-buttons">
          {
            ((canCreate && userLevel === 'admin') || userLevel === 'superAdmin') && <button className="add" onClick={() => { setShowAddReward(true) }}>Agregar Recompensa</button>
          }
          {
            checkRewardType3 &&
            <CsvDownloader
        ...
        {
          ((canRequest && userLevel === 'admin') || userLevel === 'superAdmin') &&
          <>
      ...
      <AddReward show={showAddReward} setShow={setShowAddReward} handleEvent={handleRewards}></AddReward>
      <EditReward show={showEditModal} setShow={setShowEditModal} handleEvent={handleRewards} data={reward}></EditReward>
    </AdminContain>
  )
}
