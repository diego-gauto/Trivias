...
const UserFilters = (props: IFilters) => {
  ...
  const startFilters = async (filterType: number, value: any, date: any) => {
    ...
    await filteredData(filters, date, filterValue, pageIndex).then(
      (data: any) => {
    ...
    <FilterContainer show={showFilters}>
      <div className='content'>
        ...
        <div className='filter-contain'>
          ...
          <select
            defaultValue='todos'
            onChange={(e) => startFilters(0, e.target.value, changeDate)}
          >
        ...
        <div className='filter-contain'>
          ...
          <select
            defaultValue='todos'
            onChange={(e) => startFilters(1, e.target.value, changeDate)}
          >
            <option value='todos'>Todos</option>
        ...
        <div className='filter-contain'>
          ...
          <select
            defaultValue='todos'
            onChange={(e) => openCalendar(0, e.target.value)}
          >
        ...
        <div className='filter-contain'>
          ...
          <select
            defaultValue='todos'
            onChange={(e) =>
              startFilters(3, parseInt(e.target.value), changeDate)
            }
          >
        ...
        <div className='filter-contain'>
          ...
          <select
            defaultValue='todos'
            onChange={(e) => openCalendar(1, e.target.value)}
          >
            <option value='todos'>Fechas Normal</option>
            <option value='abrir'>Calendario</option>
          </select>
        ...
        <div className='filter-contain'>
          ...
          <select
            defaultValue='todos'
            onChange={(e) => startFilters(5, e.target.value, changeDate)}
          >
            <option value='todos'>Todos</option>
        ...
        <div className='filter-contain'>
          ...
          <select
            defaultValue='todos'
            onChange={(e) => startFilters(6, e.target.value, changeDate)}
          >
            <option value='todos'>Todos</option>
        ...
        {allCourses.length > 0 ? (
          <div className='filter-contain'>
            ...
            <select
              defaultValue='todos'
              onChange={(e) =>
                startFilters(7, parseInt(e.target.value), changeDate)
              }
            >
              <option value={-1}>Todos</option>
          ...
          <div className='filter-contain'>Cargando...</div>
        )}
        {arrayFilter[7] !== -1 && (
          <div className='filter-contain'>
            ...
            <select
              defaultValue='todos'
              onChange={(e) =>
                startFilters(8, parseInt(e.target.value), changeDate)
              }
            >
