          ...
          <TitleContain>
            <TitleEdit>
              <Title>
                {name}
                {!openSeason && (
                  <EpisodesNumber>{lessons?.length} Lecciones</EpisodesNumber>
                )}
              </Title>
              <Button onClick={onSeasonEditClick}>Editar</Button>
            </TitleEdit>
            <ButtonContain>
              {openSeason && (
                <>
                  ...
                  <Button
                    onClick={() => {
                      setShow(true), setDeleteMessage(2);
                    }}
                  >
                    Eliminar temporada <TrashIcon />
                  </Button>
