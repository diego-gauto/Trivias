...
const Edit = () => {
  ...
  const getThisLesson = () => {
    getLesson(
      routerState.courseID,
      routerState.seasonID,
      routerState.lessonID,
    ).then((res: any) => {
      if (!('quiz' in res)) {
        res.quiz = {};
      } else {
  ...
  return (
    <Container>
      <TitleContain>
        ...
        <Button
          onClick={() => {
            setShow(true), setDeleteMessage(1);
          }}
        >
          Eliminar Lección <TrashIcon />
        </Button>
      </TitleContain>
      <EditContain>
        <div className='top'>
              ...
              <InputContain>
                ...
                <Extra>
                  {lesson.extra?.map((val: any, index: any) => {
                    return (
                      <p key={'Lesson Extra Material' + index}>
                        {val.title}{' '}
                        <i
                          onClick={() => {
        ...
        <div className='bottom'>
          <div className='toggle'>
            <div
              ...
              style={{
                background: type == 'homework' ? '#6717cd' : 'none',
                color: type == 'homework' ? '#fff' : '#6717cd',
              }}
            >
              Tarea
            </div>
            <div
              ...
              style={{
                background: type == 'quiz' ? '#6717cd' : 'none',
                color: type == 'quiz' ? '#fff' : '#6717cd',
              }}
            >
              Quiz
            </div>
      ...
      <ButtonContain>
        ...
        >
          <TransparentButton>Regresar</TransparentButton>
        </Link>
