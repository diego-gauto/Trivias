...
const SeasonsMain = () => {
  ...
  const [seasonEditModalData, setSeasonEditModalData] =
    useState<ISeasonEditModalData>();
        ...
        <AdminContain>
          ...
          <CourseContain>
            ...
            <LessonContain>
                      ...
                      {(provided) => (
                        <div
                          ...
                          style={{
                            ...
                            gap: '10px',
                            minHeight: 96 * seasons.length,
                          }}
                        >
                          {seasons.map((e: any, i: any) => {
                            return (
                              <Draggable
                                draggableId={`season-` + i}
                                index={i}
                                key={'season-item-' + i}
                              >
                                {(provided, snapshot) => (
              ...
              <NewSeasonContain>
                <NewSeason onClick={createNewSeason}>
