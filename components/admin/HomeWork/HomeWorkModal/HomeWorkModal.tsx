  ...
  const changeCommentValue = (approved: any) => {
    ...
    if (approved === 1) {
      ...
      setReview({
        ...review,
        comment:
          'Lamentablemente tu tarea no cuenta con las pautas para ser aprobada. Te invitamos a que la hagas nuevamente y la vuelvas a entregar.',
        approved: approved,
      });
    }
    setTimeout(() => {
        ...
        <Container>
          ...
          {data && data.status == false && (
            <DataContain>
              ...
              <ItemContain>
                <Text>Curso</Text>
                <Text2>{data.courseTitle}</Text2>
              </ItemContain>
              <ItemContain>
                <Text>Módulo</Text>
                <Text2>{data.seasonTitle}</Text2>
              </ItemContain>
              <ItemContain>
                <Text>Lección</Text>
                <Text2>{data.lessonTitle}</Text2>
              </ItemContain>
              <ItemContain>
                <Text>Puntos</Text>
                <Text2>{data.lessonPoints}</Text2>
              </ItemContain>
              <InputContain>
