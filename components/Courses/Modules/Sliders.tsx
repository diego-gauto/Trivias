...
const Sliders = (props: ICourseData) => {
  ...
  let slider: any = document.querySelector(
    `.scroll-container${slideNumber}`,
  ) as HTMLElement;
  ...
  const goTo = (courseData: ICourse) => {
    if (slideType === 'continue-watching') {
      router.push({
        ...
        query: {
          id: courseData.id,
          season: courseData.currentSeason,
          ...
          <div className={loading ? 'skeleton-product' : 'reveal-arrows'}>
            ...
            <div className='grey-field' style={{ maxWidth: 'fit-content' }}>
              <Title>
                {texts.title}
                {texts.spanAditional !== '' && (
                  <span className='span-additional'>{texts.spanAditional}</span>
                )}
                <span className='span-title'>{texts.spanTitle}</span>
            ...
            <SlideContain
              className={`scroll-slide scroll-container` + slideNumber}
            >
              <div className='slide-mod' onMouseDown={mouseDownHandler}>
                {courses.map((course: ICourse, index: number) => {
                  return (
                    <div
                      key={'Course_' + index + slideNumber}
                      id='grey-field'
                    ...
                    >
                      ...
                      >
                        ...
                        <p className='sub'>
                          de <span>{course.professors[0]?.name}</span>
                        </p>
                        <p className='modules'>
            ...
            {slideType === 'makeup-courses' && (
              <ButtonContain>
                ...
                {!user && (
                  <div
                    className='grey-field'
                    style={{ maxWidth: 'fit-content', position: 'relative' }}
                    onClick={sendTo}
                  >
                    <PurpleButton>Adquiere Gonvar+</PurpleButton>
                  </div>
