...
import { Stats, StatsByDate } from "../../containers/SuscriptionStats/ISuscrioptionsStats";
...
export const getStatsByDate = async (date: string) => {
  return axios
    ...
    .then((res) => {
      ...
      const stats: StatsByDate = { new: news, renewed: renewed, reactive: reactive, canceled: canceled, inactive: inactive }
      return stats;
    })
    .catch((error) => {
      console.log(error);
