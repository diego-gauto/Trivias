...
export const getNotifications = async (user: any) => {
  return axios.post<NotificationByUser[]>(
    'https://gonvar.inowu.dev/' + 'notifications/by-user',
    user,
  );
};
...
export const updateAllNotificationStatusApi = async (user: any) => {
  return axios
    .post(
      'https://gonvar.inowu.dev/' + 'notifications/updateAllNotifications',
      user,
    )
    .then((res) => {
      return res;
...
export const getAdminMassiveLotteryApi = async () => {
  return axios.post<{ data: AdminMasiveLoterryRow[]; user_count: number }>(
    'https://gonvar.inowu.dev/' + 'notifications/adminMassiveLottery',
  );
};
