...
export const generateUserRoleAccessQuery = (userId: number) => {
  const query = `SELECT id, 
    ...
    SELECT id, 
      role, 
      'admin_coupons' AS source_table, 
      admin_coupons.create, 
      admin_coupons.edit, 
      admin_coupons.delete, 
      admin_coupons.view, 
      user_id, 
      NULL AS courses,
      NULL AS request,
    ...
    SELECT id, 
      role, 
      'admin_rewards' AS source_table, 
      admin_rewards.create, 
      admin_rewards.edit, 
      admin_rewards.delete, 
      admin_rewards.view, 
      user_id, 
      NULL AS courses,
    ...
    SELECT id, 
      role, 
      'admin_payments' AS source_table, 
      NULL AS 'create', 
      NULL AS 'edit', 
      NULL AS 'delete', 
      admin_payments.view, 
    ...
    SELECT id, 
      role, 
      'admin_homeworks' AS source_table, 
      NULL AS 'create', 
      NULL AS 'edit', 
      NULL AS 'delete', 
      admin_homeworks.view, 
      user_id, 
    ...
    SELECT id, 
      role, 
      'admin_comments' AS source_table, 
      admin_comments.create, 
      admin_comments.edit, 
    ...
    SELECT id, 
      role, 
      'admin_trivias' AS source_table, 
      admin_trivias.create, 
      admin_trivias.edit, 
      NULL AS 'delete', 
      admin_trivias.view, 
      user_id, 
    ...
    SELECT id, 
      role, 
      'admin_trivias_list' AS source_table, 
      NULL AS 'create', 
      NULL AS 'edit', 
      NULL AS 'delete', 
      admin_trivias_list.view, 
      user_id, 
      NULL AS courses,
      NULL AS request,
      NULL AS report,
    ...
    SELECT id, 
      role, 
      'admin_forms_list' AS source_table, 
      NULL AS 'create', 
      NULL AS 'edit', 
      NULL AS 'delete', 
      admin_forms_list.view, 
      user_id, 
      NULL AS courses,
      NULL AS request,
      NULL AS report,
    ...
    SELECT id, 
      role, 
      'admin_tickets_list' AS source_table, 
      NULL AS 'create', 
      NULL AS 'edit', 
      NULL AS 'delete', 
      admin_tickets_list.view, 
      user_id, 
      NULL AS courses,
      NULL AS request,
      NULL AS report,
    ...
    SELECT id, 
      role, 
      'admin_memberships_list' AS source_table, 
      NULL AS 'create', 
      NULL AS 'edit', 
      NULL AS 'delete', 
      admin_memberships_list.view, 
      user_id, 
      NULL AS courses,
      NULL AS request,
      NULL AS report,
