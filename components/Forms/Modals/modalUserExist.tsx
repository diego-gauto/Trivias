      ...
      <Overlay>
        <ModalContainer>
          ...
          <ContentContainer>
            ...
            <h5>
              El correo que ingresaste ya había solicitado la beca con
              anterioridad
            </h5>
            <h6>
              Si el correo es correcto, te invitamos a navegar nuestra
              plataforma y tomar alguno de nuestros cursos gratuitos
            </h6>
          ...
          <ButtonContainer>
            ...
            <RedirectButton onClick={() => closeModal(false)}>
