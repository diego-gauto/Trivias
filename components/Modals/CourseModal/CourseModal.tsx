  ...
  return (
    <ModalContain>
      <ModalMod show={show} onHide={handleClose} size='lg' centered>
        <ModalCont>
          <ModalBackground>
            <ImageBack src={course.image} width={1000} height={600} />
            <Container>
              <div className='top'>
                <img src={gPlus} />
          ...
          <CourseContain level={course.difficulty}>
            {!responsive990 && (
              <div className='left'>
                ...
                <div className='level-container'>
                  {course.difficulty == 'Muy Fácil' && (
                    <img
                      style={{ width: 'auto' }}
                      src='../images/iconoAzul.png'
                      alt=''
                    />
                  )}
                  ...
                  {course.difficulty == 'Avanzado' && (
                    <img
                      style={{ width: 'auto' }}
                      src='../images/iconoVerde.png'
                      alt=''
                    />
                  )}
                  {course.difficulty == 'Máster' && (
                    <img
                      style={{ width: 'auto' }}
                      src='../images/iconoRosa.png'
                      alt=''
                    />
                  )}
                  <div className='difficulty-word'>
                    ...
                    <InformationIcon>
                      ...
                      <label
                        className='info-box'
                        style={{ left: 210, borderRadius: '10px 10px 10px 0' }}
                      >
                        {course.difficulty === 'Muy Fácil' &&
                          'Recomendado para personas principiantes'}
                        {course.difficulty === 'Fácil' &&
                          'Recomendado para personas a partir de 3 meses de experiencia'}
                        {course.difficulty === 'Intermedio' &&
                          'Recomendado para personas a partir de 6 meses de experiencia'}
                        {course.difficulty === 'Avanzado' &&
                          'Recomendado para personas a partir de un año de experiencia'}
                        {course.difficulty === 'Máster' &&
                          'Recomendado para personas a partir de un año de experiencia y con capacitación constante'}
                      </label>
                    </InformationIcon>
                  </div>
                </div>
            ...
            {responsive990 && (
              <div className='responsive-top-info'>
                <div className='left'>
                  <p className='title'>{course.title}.</p>
                  <div className='level-container'>
                    {course.difficulty == 'Muy Fácil' && (
                    ...
                    <img
                      src={
                        course.professors?.length
                          ? course.professors[0].image
                            ? course.professors[0].image
                            : DEFAULT_PROFESSOR_IMAGE
                          : DEFAULT_PROFESSOR_IMAGE
                      }
                      alt=''
                    />
                    <p>
                      CONOCE A <span>TU INSTRUCTOR</span> <br />
                      <span className='name'>
                ...
                <div className='right'>
                  <div className='rating'>
                    <p>
                      {course.rating ? course.rating / 20 : 0}{' '}
                      <span className='review-count'>({course.reviews})</span>
                    </p>
                    <Rating
                      allowHover={false}
                      readonly={true}
                      ratingValue={course.rating ? course.rating : 0}
                      emptyColor='#3f1168'
                      emptyIcon={<AiFillStar></AiFillStar>}
                      fullIcon={<AiFillStar></AiFillStar>}
                      fillColor='#ff9b00'
                    ></Rating>
                  </div>
                  <p className='time'>Duración estimada</p>
              ...
              return (
                <ContainerVideo key={'lesson ' + index}>
                  <VideoContain>
                    <ContainVideo>
                      <EpisodeContain
                        className={isPlaying ? 'skeleton-product' : ''}
                      >
                        <div
                    ...
                    <EpisodeInfo>
                      {'mandatory' in lesson ? (
                        ...
                        <EpisodeTitle>Lección {index + 1}</EpisodeTitle>
                      )}
