    ...
    >
        ...
        <div className='upper-contain'>
          <div className='first-container'>
            <div className='text-contain'>
              <img src={GonvarLogo} />
              <p className='text'>Gonvar+</p>
            </div>
            <p className='subs-text'>Suscripción mensual</p>
          </div>
        ...
        <div className='bottom-contain'>
          <div className='first-container'>
            <p className='text'>
              Por favor, pasa.
              <br />
              <span>¡Te estábamos esperando!</span>
            </p>
          </div>
      ...
      <Middlecontainer ref={ref}>
        <div className='main-title'>
          <p className='text-title'>
            ...
            <span> a todos los siguientes artículos </span>
            <span className='span2'>*</span>
            <br />
            con una <span>única suscripción mensual de Gonvar+</span>
            <br />
            <span className='span3'>
              por sólo $149 <span style={{ fontWeight: 500 }}>MXN/mes</span>
            </span>
          </p>
          <div className='bottom-container'>
            ...
            <div className='left-text'>
              <p className='text'>
                <span className='span1'>*</span> Costo ordinario sin suscripción{' '}
                <br />
            ...
            <div className='cards-position'>
                ...
                <div className='card-content'>
                  ...
                  <div className='info-texts'>
                    <p className='first-text'>
                      Más de 25 cursos y 300 clases deuñas y belleza en línea
                    </p>
                    <p className='second-text'>
                      Con instructores profesionales, niveles desde básicos a
              ...
              <div className='card-container'>
                ...
                <div className='card-content'>
                  ...
                  <p className='first-text'>
                    Revisión de prácticas y asesorías ilimitadas
                  </p>
                  <p className='price-text'>
                  ...
                  <p className='first-text'>
                    40% de descuento en productos Gonvar
            ...
            <div className='cards-position'>
              <div className='card-container'>
                ...
                <div className='card-content'>
                  ...
                  <div className='info-texts'>
                    <p className='first-text'>
                      Un Mini Kit con diferentes productos cada dos meses
                    </p>
                    <p className='second-text'>
                      Acrílicos, geles, monómeros, adherentes, decoración y más.
                    </p>
                  </div>
                  <p className='price-text'>
                    $650 MXN<span> ª</span>
              ...
              <div className='card-container'>
                ...
                <div className='card-content'>
                  ...
                  <div className='info-texts'>
                    <p className='first-text'>
                      Rifa trimestral donde podrás ganar hasta{' '}
                      <span>$20,000 MXN</span> en premios.
                    </p>
                    <p className='second-text'>
                      Por cada mes inscrito en Gonvar+ recibes un boleto
                      adicional.
                    </p>
                  </div>
                  <p className='price-text'>
      ...
      <BottomContainer>
                ...
                <CoursesContainer key={'Course data ' + index}>
                  <div className='image-contain'>
                    <button
                      className='btn-info'
                      onClick={() => {
                        setShowModal(true), setCourseModal(val);
                      }}
                    >
                      Más información
                    </button>
                  ...
                  <div className='course-info'>
                    <p className='course-name'>{val.title}</p>
        ...
        <div className='footer-text'>
          <p className='text-1'>
            ª Costo promedio al adquirirlo de forma individual.
            <br />¹ Primer mes en <span>Gonvar+</span> 10% dto.; 3 meses 20%
            dto.; 6 meses 40% dto.
            <br />² Costo por cada boleto para participar en la rifa.
          </p>
        </div>
      </BottomContainer>
      <CourseModal
