...
const WelcomeModal = (props: IWelcomeModal) => {
  ...
  const VideoPlayer =
    'https://video.gonvar.io/media/instrucciones/1_04/master.m3u8';
  return (
    <Modal show={show} onHide={handleClose} size='lg' centered>
      <WelcomeContainer>
        <div className='title-container'>
          <h1 className='title'>
            Bienvenida a tú nueva plataforma, ve este video para conocer mas
            sobre la experiencia <span>Gonvar</span>.
          </h1>
