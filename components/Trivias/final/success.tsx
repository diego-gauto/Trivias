...
const Success = () => {
  ...
  return (
    <div className={successContainer}>
      ...
      <p className={ganaste}>
        Ganaste el acceso a{' '}
        <span className={span}>más de 70 cursos de uñas y belleza </span>en
        línea con un descuento especial.
      </p>
      <p className={red}>
      ...
      <p className={revisa}>
        Revisa tu correo electrónico para conocer los pasos para suscribirte y
