      ...
      <div className='break plan-container'>
        <div className='header'>
          ...
          <div className='d-flex justify-content-center mb-3'>
            <button className='purple-button' onClick={goTo}>
              Comenzar ahora
            </button>
          </div>
        </div>
        <div className='main-body'>
          <div className='back tip m-2' onClick={() => verQ(1)}>
            <div className='tip-q mb-1'>
              <p className='green m-0'>
                4 meses de acceso a Nails Master Revolution
              </p>
              {views.get(1) ? (
                <BsChevronUp className='tip-icon Back-green' />
              ) : (
            ...
            {views.get(1) && (
              <div className='b-green'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  Obtén acceso al curso{' '}
                  <b>Nail Masters Revolution durante 4 meses, </b>
          ...
          <div className='back tip m-2' onClick={() => verQ(3)}>
            <div className='tip-q mb-1'>
              <p className='green mb-0'>
                Curso definitivo de Tips y Escultural
              </p>
              {views.get(3) ? (
                <BsChevronUp className='tip-icon Back-green' />
              ) : (
            ...
            {views.get(3) && (
              <div className='b-green'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  <b>Aprende la técnica más solicitada en la industria, </b>de
            ...
            {views.get(4) && (
              <div className='b-green'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  ...
                  <b>revisamos individualmente cada una de tus prácticas, </b>
          ...
          <div className='back tip m-2' onClick={() => verQ(5)}>
            ...
            {views.get(5) && (
              <div className='b-green'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  <b>Revisamos a profundidad cada una de tus tareas </b>y te
                  damos retroalimentación para que no dejes de aprender.
                </p>
              </div>
            )}
          </div>
          ...
          <div className='back tip m-2' onClick={() => verQ(6)}>
            ...
            {views.get(6) && (
              <div className='b-green'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  Un programa enfocado en emprendimiento{' '}
                  <b>para comenzar tu propio negocio.</b>
                </p>
              </div>
            )}
          </div>
          ...
          <div className='back tip m-2' onClick={() => verQ(7)}>
            ...
            {views.get(7) && (
              <div className='b-green'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  Al finalizar tu curso, obtén un <b>certificado oficial</b> de
                  la marca.
                </p>
              </div>
            )}
          ...
          <div className='back tip m-2' onClick={() => verQ(8)}>
            ...
            {views.get(8) && (
              <div className='b-green'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  <b>
                    Tendrás acceso a nuestros manuales exclusivos para avanzar
                    en este entrenamiento,{' '}
                  </b>
                  con todos los archivos que necesitarás para avanzar en tu
                  carrera de aplicadora de uñas.
                </p>
              </div>
            )}
          </div>
