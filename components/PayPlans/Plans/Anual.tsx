  ...
  */
  const generateButton = (): JSX.Element => {
    ...
    const isAbleToUpdate =
      user &&
      isActiveUser() &&
      (haveCuatrimestralSuscription() || haveMonthSuscription()) &&
      !isPaypalUser();

    if (isAbleToUpdate) {
      return (
        <button className='purple-button' onClick={onClickUpdateHandler}>
    ...
    return (
      <button className='purple-button' onClick={(e) => goTo(user, 'A')}>
    ...
    <PlanStyles>
      ...
      <div className='back plan-container'>
        <div className='header'>
          <div className='top-tab border Back-blue'></div>
        ...
        <div className='main-body'>
          ...
          <div className='break tip m-2' onClick={() => verQ(11)}>
            ...
            {views.get(11) && (
              <div className='b-blue'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  Una vez al mes recibe una clase en vivo con{' '}
                  <b>instructores oficiales.</b> Resuelve tus dudas y sigue
                  aprendiendo
                </p>
              </div>
            )}
