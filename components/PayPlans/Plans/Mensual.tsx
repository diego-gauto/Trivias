    ...
    <PlanStyles>
      <div className='break plan-container'>
        <div className='header'>
          <div className='top-tab border Back-p-pink'></div>
          <div className='title b-p-pink mx-4 mt-3'>
            <img src={gPlus} alt='Gonvar logo' className='mt-3 me-2' />
            <div>
              <p className='purple-pink mb-0'>Suscripción Gonvar+</p>
          ...
          <div className='d-flex justify-content-center mb-3'>
            <button className='purple-button ' onClick={(e) => goTo(user, 'M')}>
              Comenzar plan <br /> Mensual
            </button>
          </div>
        </div>
            ...
            {views.get(3) && (
              <div className='b-p-pink'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  ...
                  <b>ganas miles de pesos en productos y premios</b> sólo por
                  permanecer suscrita, concluir tus cursos y hacer tus tareas.
                </p>
              </div>
            )}
          </div>
