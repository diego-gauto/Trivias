  ...
  const goTo = () => {
    if (user.id) {
      router.push({
        ...
        query: { nailmasterplusanual: true },
      });
    } else {
        ...
        <div className='main-body'>
          <div className='break tip m-2' onClick={() => verQ(1)}>
            <div className='tip-q mb-1'>
              <p className='purple-pink2 m-0'>
                3 meses de acceso a Nails Master 2.0
              </p>
              {views.get(1) ? (
                <BsChevronUp className='tip-icon Back-p-pink2' />
              ) : (
          ...
          <div className='break tip m-2' onClick={() => verQ(2)}>
            ...
            {views.get(2) && (
              <div className='b-p-pink2'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  <b>Curso de uñas y belleza en línea, </b>con Instructores
            ...
            {views.get(3) && (
              <div className='b-p-pink2'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  ...
                  <br />A partir del 6° mes suscrita,{' '}
                  <b>recibe 40% de descuento.</b>
                </p>
              </div>
            )}
          </div>
          ...
          <div className='break tip m-2' onClick={() => verQ(4)}>
            ...
            {views.get(4) && (
              <div className='b-p-pink2'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  <b>
                    Centro de Recompensas, donde ganas miles de pesos en
                    productos y premios{' '}
                  </b>
          ...
          <div className='break tip m-2' onClick={() => verQ(5)}>
            ...
            {views.get(5) && (
              <div className='b-p-pink2'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  <b>
                    Todos nuestros instructores son profesionales de la belleza,{' '}
                  </b>
          ...
          <div className='break tip m-2' onClick={() => verQ(7)}>
            <div className='tip-q mb-1'>
              <p className='purple-pink2 mb-0'>
                Kit de producto Gratis + envios gratis
              </p>
              {views.get(7) ? (
                <BsChevronUp className='tip-icon Back-p-pink2' />
              ) : (
            ...
            {views.get(7) && (
              <div className='b-p-pink2'>
                <p className='mb-0 pt-2 animate__animated animate__fadeIn no-bold just'>
                  Recibe un kit con diferentes productos cada mes, más{' '}
                  <b>envios gratis en compras mayores </b>a $1,000.00 MXN.
                </p>
              </div>
            )}
          </div>
