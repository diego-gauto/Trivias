        ...
        <div className='back'>
          ...
          <div className='select-plan'>
            <div className='options'>
              <p
                className={`option ${selected === 1 ? 'link' : ''}`}
                onClick={() => handleSelected(1)}
              >
                Mensual
              </p>
              <p
                className={`option ${selected === 3 ? 'link' : ''}`}
                onClick={() => handleSelected(3)}
              >
                Cuatrimestral
              </p>
              <p
                className={`option ${selected === 2 ? 'link' : ''}`}
          ...
          <div className='subtitle text-center py-3'>
            <h3 className='h4'>
              <b>Nunca subiremos el precio</b> si mantienes tu suscripción
              activa.
            </h3>
            <div className='d-inline-flex'>
              <p className='no-bold mt-3'>
                Usa el método de pago más cómodo para ti:{' '}
              </p>
              <div
                style={{
                  display: 'flex',
          ...
          <button className='continue my-4 d-flex mx-auto' onClick={goTo}>
          ...
          <div className='break  py-2 px-5'>
            <div className='m-5'>
              <h2 className='h3 text-center mb-5'>
                Impulsa tu{' '}
                <b className='purple-pink no-bold'>
                  creciemiento profesional como Nail Artist
                </b>
              ...
              <div className='row'>
                ...
                <div className='col-sm-4 text-center'>
                  <h2>+70 cursos</h2>
                  <p>
                    donde aprenderás desde cero y paso a paso técnicas
                    actualizadas.
                  </p>
                </div>
                <div className='col-sm-4 text-center'>
