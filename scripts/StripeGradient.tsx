      ...
      Object.defineProperties(_miniGl, {
          ...
          value: class {
            ...
            constructor(vertexShaders: any, fragments: any, uniforms = {}) {
              ...
              function getUniformVariableDeclarations(
                uniforms: { [s: string]: any } | ArrayLike<any>,
                type: string
              ) {
        ...
        Uniform: {
          ...
          value: class {
            ...
            //t - type
            //n - length
            getDeclaration(name: string, type: any, length: number) {
              const uniform = this;
                ...
                if ("struct" === uniform.type) {
                  ...
                  return (
                    ...
                    `uniform struct ${name_no_prefix} 
                                {\n` +
                      Object.entries<any>(uniform.value)
                        .map(([name, uniform]) =>
                          uniform
          ...
          value: class {
            ...
            constructor(geometry: any, material: any) {
              ...
              (mesh.geometry = geometry),
                ...
                Object.entries<any>(mesh.geometry.attributes).forEach(
                  ([e, attribute]) => {
            ...
            draw() {
              context.useProgram(this.material.program),
                this.material.uniformInstances.forEach((obj: any) => {
                  const e = obj.uniform;
                  const t = obj.location;
                  e.update(t);
                }),
                this.attributeInstances.forEach((obj: any) => {
                  const e = obj.attribute;
                  const t = obj.location;
                  e.use(t);
                }),
