...
function Trivias() {
  ...
  const trivias = [
    ...
    {
      id: 1,
      img: "/images/mujer2-removebg-preview.png",
        ...
        result: [
          {
            ...
            body: `Se nota tu experiencia a kilómetros.
               Siéntete afortunada de poder vivir de hacer lo que más te gusta pero no 
               olvides que el mundo de las uñas está en un cambio constante donde la 
               capacitación y actualizaciones sobre las nuevas tendencias harán que tu 
               crecimiento profesional no se detenga.`,
            img: "/images/mujerinfluencer.svg",
          },
          {
