    ...
    <BlogContainer>
        ...
        >
          <FirstSection>
            <div className='title-container'>
              ...
              <p className='sub-title'>{blog?.subtitle}</p>
              <p className='date'>
                por Gonvar | {blog?.date.day} de {blog?.date.month} de{' '}
                {blog?.date.year}
              </p>
              <div className='socials'>
                <div className='content'>
                  ...
                  <p className='text-display'>Compartir en Facebook</p>
                </div>
                <div className='content'>
                  <WhatsappShareButton
                    url={url}
                  ...
                  <p className='text-display'>Compartir en Whatsapp</p>
                </div>
                {/* <div className='content'>
                ...
                <div className='content'>
                  ...
                  />
                  <p className='text-display'>Copiar Link</p>
                  {linkCopied && (
          ...
          <BoxSection>
            <div className='title-contain'>
              <p className='title'>En este artículo aprenderás</p>
            </div>
                ...
                if (topic.title) {
                  ...
                  return (
                    <div
                      ...
                      key={'topic-titles ' + index}
                    >
                      <p className='number'>{topicTitleCount}.</p>
                  ...
                  return (
                    <React.Fragment key={'topicCase_' + index}></React.Fragment>
                  );
                }
              })}
              <div className='section-title'>
                <p className='number'>{topicTitleCount + 1}.</p>
                <p
                  className='topic-title'
                  onClick={() => moveTo(topicLength + 1)}
                >
                  ...
                  {index == 0 && (
                    <GonvarAd>
                      ...
                      <div className='all-texts'>
                        <p className='space'>
                          ¡<strong>Descarga Gratis</strong> tus libros de
                          belleza favoritos!
                        </p>
                        <ul>
                          <li>
                        ...
                        <p className='space'>
                          Totalmente gratis, comienza a aprender todo sobre
                          belleza en nuestros manuales Gonvar.
                        </p>
                        <p className='space'>
                          Solo haz click aquí abajo, elige tus manuales y compra
                          sin costo.
                        </p>
                        <div className='button-contain'>
                          {/*
                              ...
                              */}
                          <a
                            className='button-gonvar'
                            style={{ textDecoration: 'none' }}
                            target='_blank'
                            href='https://bit.ly/3J3ofsV'
                          >
                            Descargar Manuales
                          </a>
                        </div>
      ...
      <BottomSection>
        <div className='title-contain' id={`box-${topicLength + 1}`}>
          <p className='title'>Artículos relacionados</p>
        </div>
