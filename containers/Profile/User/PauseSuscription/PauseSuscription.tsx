  ...
  return (
    <PauseSub>
      <div className='m-3'>
          ...
          <div className='dimScreen animate__animated animate__slideInUp'>
            <div id='confirmBox' className='dialog'>
              ...
              <h1 className='purple-dark'>
                Tu cuenta fue pausada exitosamente
              </h1>
              <p className='my-3'>
                Te enviamos un correo confirmando esta acción.
                <br />
                <b>
                  Tu cuenta estará suspendida por un periodo de un mes.
                </b>{' '}
                <br /> Terminado este tiempo, se hará nuevamente el cargo
                automatico a tu tarjeta.
              </p>
              <p>
                <i>
                  <b>Fecha de reinicio de la inscripcion {'(00/00/000)'}</b>
                </i>
              </p>
              <p>
                No te preocupes, puedes cancelar definitivamente tu cuenta en
                cualquier momento que lo decidas.
              </p>
        ...
        <p>
          <b>
            Se que existen multiples razones por las que ya no puedes continuar
            con tu carrera de nails artist.
          </b>
        </p>
        <p className='my-0'>
          ¡Estamos en confianza! Platícame el motivo por el que quieres pausar
          tu suscripción:
        </p>
        ...
        <div className='buttons mt-5'>
          <button onClick={() => setPop(true)} className='left'>
