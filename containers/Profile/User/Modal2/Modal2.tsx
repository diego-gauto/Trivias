    ...
    <Modal2Contain>
      <Modal show={show} onHide={handleClose} centered>
        <Container>
          ...
          <Membership>
            <MemberText>Gonvar Plus</MemberText>
            <RenewalText>Renovación el {formatDate}</RenewalText>
          </Membership>
          <PaymentMethod>
            <MemberText>Método de Pago</MemberText>
            <PayMethod>
              {data.membership.method == 'stripe' && (
                <CardInfo>
          ...
          {methods && (
            <PaymentMethod>
              <MemberText>Métodos de Pago</MemberText>
              {!loader &&
                pm.map((cards: any) => {
                  return (
                    <PayMethod>
                      ...
                      {!cards.default ? (
                        ...
                        <NewMethod>Predeterminada</NewMethod>
                      )}
                    </PayMethod>
                  );
                })}
