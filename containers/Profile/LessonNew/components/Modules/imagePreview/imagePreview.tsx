      ...
      <ImageContainter>
        ...
        <div className='row'>
          <div className='text-contain col-lg-5 col-md-12'>
            <h2 className='purple h1 fw-semibold text-center'>
              ¡Hola, <b>{user}</b>!
            </h2>
            <p className='purple h2 fw-semibold text-center'>
              Estás por entregar tu tarea de <b>{lesson}.</b>
            </p>
            <p className='purple h2 fw-semibold text-center'>
              Recibirás tu <b>calificación</b> y <b>retroalimentación</b> en
              esta sección y por correo electrónico.
            </p>
            <p className='purple h2 fw-semibold text-center'>
              Si subiste la <b>tarea correcta</b>, sólo da click en aceptar para
              enviarla.
            </p>
            {type !== 'aplication/pdf' && type.substring(0, 5) !== 'image' && (
              <p className='note'>
                (Los documentos .doc y .docx no cuentan con vista previa)
              </p>
            )}
