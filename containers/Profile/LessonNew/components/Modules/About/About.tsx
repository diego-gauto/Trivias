    ...
    <AboutContain>
      <TextContainer>
        ...
        <LessonContent>
            ...
            <>
              ...
              <div className='order-material'>
                {lesson.lesson_material.map((extra: any, index: number) => {
                  return (
                    <span key={'extra_material_' + index} className='pdf'>
                      {extra.title}
                      <a
                        className='btn-material-apoyo-pdf'
                        target='_blank'
          ...
          <p>
            Da click en el botón de abajo para que puedas ver los materiales que
            necesitarás para este curso.
          </p>
