...
const Modules = ({ data, user, comments, season, lesson, teacherId }: any) => {
    ...
    <MainContainer>
      {
        position === 1
          ...
          position === 3
            ? <HomeWork value={position} setValue={setPosition} data={data} user={user} season={season} lesson={lesson} teacherId={teacherId} /> :
            position === 4
